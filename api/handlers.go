...
type ScanRequest struct {
	...
	TargetRange string `json:"target_range"` // e.g. "192.168.1.0/24" or "192.168.1.5"; required for "quick"; for "deep": explicit target when non-empty, fallback to known IPs when empty; for "mac": optional single-IP or CIDR filter over known IPs
}
